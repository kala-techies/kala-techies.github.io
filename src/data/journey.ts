...
export const sceneCaptions: SceneCaption[] = [
  ...
  },
  {
    ...
    beats: [
      ...
      { at: 0.06, heading: "Messaging", line: "Sometimes we just send a message." },
      { at: 0.12, heading: "Dead Letters", line: "And sometimes messages fail." },
      { at: 0.2, heading: "Dead Letters", line: "That's when the dead letters start piling up." },
      { at: 0.3, heading: "Topic", line: "One event can reach many consumers." },
    ],
  },
  {
    id: "automation",
