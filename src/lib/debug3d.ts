...
export const BEAT_META: Record<BeatId, BeatMeta> = {
  ...
  impactMarker1: { label: "Impact marker 1 (Renan)", zone: "impact", triggerProgress: 0.4, peakProgress: 0.55 },
  impactMarker2: { label: "Impact marker 2 (Manjunath)", zone: "impact", triggerProgress: 0.65, peakProgress: 0.78 },
