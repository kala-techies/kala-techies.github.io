...
export const BEAT_META: Record<BeatId, BeatMeta> = {
  ...
  securityKeyVault: { label: "Security Key Vault secret retrieval", zone: "security", triggerProgress: 0.3, peakProgress: 0.45 },
  serviceBusFanout: { label: "Service Bus topic fan-out", zone: "servicebus", triggerProgress: 0.1, peakProgress: 0.22 },
  serviceBusDeadLetter: { label: "Service Bus dead-letter accumulation", zone: "servicebus", triggerProgress: 0.1, peakProgress: 0.32 },
