          ...
          {experience.map((entry, i) => (
            <Reveal key={entry.company} delay={i * 0.06}>
              <div className="relative sm:pl-10">
                ...
                <div className="rounded-2xl border border-border bg-surface/50 p-6 transition-colors hover:border-border-hover sm:p-7">
                  ...
                  <p className="mt-1 text-xs italic text-ink-faint">{entry.companyContext}</p>
                  ...
                  <div className="mt-5 flex flex-wrap gap-2">
                    {entry.tech.map((t) => (
                      <span
                        key={t}
                        className="rounded-md border border-border-hover px-2.5 py-1 font-mono text-[11px] text-ink-faint"
                      >
                        {t}
                      </span>
                    ))}
